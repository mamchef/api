...
<head>
    ...
    <title>Payment Successful - Mamchef</title>
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gradient-to-br from-mint-50 to-sage-100 flex flex-col justify-center px-6">
        <!-- Header -->
        ...
        <div class="max-w-md mx-auto w-full">
            ...
            <div class="glass rounded-2xl p-8 shadow-xl border border-white/20 text-center">
                ...
                <!-- Success Message -->
                <h1 class="text-2xl font-bold text-forest-900 mb-3">Payment Successful!</h1>
                <p class="text-forest-600 mb-2">Your order has been confirmed</p>
                
                <!-- Order Details -->
                <div class="bg-mint-100 rounded-lg p-4 mb-6">
                    <div class="text-sm text-forest-700">
                        <p><span class="font-semibold"></span> <span id="order-number">{{ $order->order_number ?? 'Loading...' }}</span></p>
                        <p><span class="font-semibold">Amount:</span> <span id="order-amount">€{{ number_format($order->total ?? 0, 2) }}</span></p>
                        <p><span class="font-semibold">Status:</span> <span class="text-success font-semibold">Confirmed</span></p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <button
                        ...
                        class="btn w-full bg-gradient-to-r from-primary-600 to-primary-700 text-white py-4 px-6 rounded-xl font-bold text-lg hover:from-primary-700 hover:to-primary-800 shadow-lg"
                    >
                        <span id="primary-button-text">Continue to App</span>
                    </button>
    ...
    <script>
        ...
        function detectDevice() {
            ...
            if (isMobile) {
                buttonText.textContent = '📱 Open Mamchef App';
                debugInfo.textContent = `${isAndroid ? 'Android' : 'iOS'} device detected`;
            } else {
                buttonText.textContent = '🌐 Continue to Website';
        ...
        function smartRedirect() {
            ...
            if (isAndroid) {
                ...
                const intent = `intent://payment/success?order_id=${orderId}#Intent;scheme=mamchef;package=com.mamchef.app;S.browser_fallback_url=${encodeURIComponent('https://app.mamchef.com/orders/' + orderId)};end`;
